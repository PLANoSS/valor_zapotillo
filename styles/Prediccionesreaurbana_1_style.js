...
var style_Prediccionesreaurbana_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("V_valor");
    var labelText = "";
    size = 0;
    ...
    if (value > 1.096740 && value <= 25.945547) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 25.945547 && value <= 52.247916) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 52.247916 && value <= 79.281119) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 79.281119 && value <= 107.554748) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 107.554748 && value <= 142.736461) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_Prediccionesreaurbana_1.getSource().getFeatures();
