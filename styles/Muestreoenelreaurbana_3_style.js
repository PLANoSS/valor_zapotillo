...
var style_Muestreoenelreaurbana_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(62,13,176,1.0)'})}),
...
function update() {
    ...
    var features = lyr_Muestreoenelreaurbana_3.getSource().getFeatures();
